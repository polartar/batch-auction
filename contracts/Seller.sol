...
// Modified by Eric Gao (@itsoksami, https://github.com/Ericxgao)
...
abstract contract Seller is OwnerPausable, ReentrancyGuard {
    ...
    */
    ...
    @param fromWhitelist Indicates that the call originated from a signed, whitelist transaction.
    */
        ...
        whenNotPaused
    {
        ...
        _handlePurchase(to, n, true, true);
    ...
    @param fromWhitelist Indicates that the call originated from a signed whitelist transaction.
     */
    function _purchase(address to, uint256 requested, bool fromWhitelist)
        internal
        nonReentrant
        whenNotPaused
    {
        ...
        _handlePurchase(to, n, false, fromWhitelist);
        _totalSold.add(n);
