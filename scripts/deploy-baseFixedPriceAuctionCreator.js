...
async function main() {
  ...
  const auctionFactory = await ethers.getContractFactory("BaseFixedPriceAuctionERC721AUpgradeable");
  ...
  console.log("FixedPriceAuctionCreator address: ", auctionCreator.address);
